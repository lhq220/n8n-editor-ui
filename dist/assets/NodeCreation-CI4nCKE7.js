const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/NodeCreator-DNlIiXc-.js","assets/index-B6CXOKcF.js","assets/index-Cu27tAiF.css","assets/NodeCreator-C5bvseS3.css"])))=>i.map(i=>d[i]);
import { d as defineComponent, T as useUIStore, cx as useFocusPanelStore, f4 as useAssistantStore, gS as useActions, h as createElementBlock, g as openBlock, f as createCommentVNode, e as createBlock, n as normalizeClass, i as createVNode, w as withCtx, a0 as _sfc_main$1, l as unref, c as useI18n, cb as KeyboardShortcutTooltip, q as N8nButton, j as createBaseVNode, c_ as _sfc_main$2, k as createTextVNode, t as toDisplayString, $ as N8nTooltip, dj as defineAsyncComponent, di as Suspense, F as Fragment, aL as __vitePreload, dl as NODE_CREATOR_OPEN_SOURCES, gT as getMidCanvasPosition, aT as STICKY_NODE_TYPE, aA as useTelemetry, gU as DEFAULT_STICKY_WIDTH, gV as DEFAULT_STICKY_HEIGHT, _ as _export_sfc } from "./index-B6CXOKcF.js";
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    const LazyNodeCreator = defineAsyncComponent(
      async () => await __vitePreload(() => import("./NodeCreator-DNlIiXc-.js"), true ? __vite__mapDeps([0,1,2,3]) : void 0)
    );
    const props = __props;
    const emit = __emit;
