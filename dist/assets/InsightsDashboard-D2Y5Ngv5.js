const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/InsightsPaywall-WZ8adQVP.js","assets/index-B6CXOKcF.js","assets/index-Cu27tAiF.css","assets/InsightsPaywall-CE5W3W4m.css","assets/InsightsChartTotal-CHni4vab.js","assets/chartjs.utils-BCHQjZjb.js","assets/InsightsSummary-D3UImey1.js","assets/InsightsSummary-DTFIhBF3.css","assets/index-DvCwDe6d.js","assets/InsightsChartFailed-BZ41CYrp.js","assets/InsightsChartFailureRate-DrUGzfk8.js","assets/InsightsChartTimeSaved-m8tv_3Z_.js","assets/InsightsChartAverageRuntime-Uc-XC6T_.js","assets/InsightsTableWorkflows-DAEy2v_K.js","assets/InsightsTableWorkflows-BTHSCwX8.css"])))=>i.map(i=>d[i]);
import { d as defineComponent, e8 as useModel, fY as useInsightsStore, r as ref, gt as UNLICENSED_TIME_RANGE, g4 as TIME_RANGE_LABELS, e as createBlock, g as openBlock, w as withCtx, h as createElementBlock, F as Fragment, y as renderList, l as unref, e1 as _sfc_main$3, k as createTextVNode, f as createCommentVNode, t as toDisplayString, j as createBaseVNode, e0 as N8nSelect, x as computed, c as useI18n, i as createVNode, p as N8nText, q as N8nButton, gu as ElDialog, am as usePageRedirectionHelper, _ as _export_sfc, a6 as useRoute, gv as INSIGHT_TYPES, dj as defineAsyncComponent, ab as watch, o as onMounted, aj as useDocumentTitle, m as N8nHeading, n as normalizeClass, dB as _sfc_main$4, b$ as resolveDynamicComponent, aA as useTelemetry, gw as TELEMETRY_TIME_RANGE, aL as __vitePreload } from "./index-B6CXOKcF.js";
import { I as InsightsSummary } from "./InsightsSummary-D3UImey1.js";
const _hoisted_1$2 = {
  key: 0,
  width: "16",
  height: "17",
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const InsightsPaywall = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsPaywall-WZ8adQVP.js"), true ? __vite__mapDeps([0,1,2,3]) : void 0)
    );
    const InsightsChartTotal = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartTotal-CHni4vab.js"), true ? __vite__mapDeps([4,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartFailed = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartFailed-BZ41CYrp.js"), true ? __vite__mapDeps([9,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartFailureRate = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartFailureRate-DrUGzfk8.js"), true ? __vite__mapDeps([10,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartTimeSaved = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartTimeSaved-m8tv_3Z_.js"), true ? __vite__mapDeps([11,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartAverageRuntime = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartAverageRuntime-Uc-XC6T_.js"), true ? __vite__mapDeps([12,1,2,5,6,7,8]) : void 0)
    );
    const InsightsTableWorkflows = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsTableWorkflows-DAEy2v_K.js"), true ? __vite__mapDeps([13,1,2,6,7,14]) : void 0)
    );
    const props = __props;
