import { d as defineComponent, r as ref, h as createElementBlock, g as openBlock, n as normalizeClass, j as createBaseVNode, f as createCommentVNode, i as createVNode, N as N8nIcon, p as N8nText, w as withCtx, X as renderSlot, _ as _export_sfc, e as createBlock, F as Fragment, A as renderList, t as toDisplayString, k as createTextVNode, l as unref, c as useI18n, c9 as useClipboard, a as useToast, x as computed, be as sortByProperty, o as onMounted, W as onBeforeUnmount, s as N8nCard, m as N8nHeading, b as useRouter, ax as useDocumentTitle, at as useRootStore, a0 as usePushConnectionStore, al as useTelemetry, b1 as onBeforeMount, dD as _sfc_main$8 } from "./index-CsUnqKhe.js";
import { _ as _sfc_main$7 } from "./PushConnectionTracker.vue_vue_type_script_setup_true_lang-ClhQwSRJ.js";
import { a as useOrchestrationStore, W as WORKER_HISTORY_LENGTH, u as usePushConnection } from "./usePushConnection-DctKXrnJ.js";
import { C as Chart } from "./index-DgQ_ZCHg.js";
          ...
          props.items.length > 0 ? (openBlock(), createElementBlock("div", {
            ...
            (openBlock(true), createElementBlock(Fragment, null, renderList(props.items, (item) => {
              return openBlock(), createElementBlock("div", {
                ...
                }, " Execution " + toDisplayString(item.executionId) + " - " + toDisplayString(item.workflowName), 9, _hoisted_1$2),
                createVNode(_component_n8n_text, {
                  color: "text-base",
                  size: "small",
                  align: "left"
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("div", null, [
        ...
        !initialStatusReceived.value ? (openBlock(), createElementBlock("div", _hoisted_1, [
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _cache) => {
      return openBlock(), createBlock(WorkerList, { "data-test-id": "worker-view-licensed" });
    };
  }
});
