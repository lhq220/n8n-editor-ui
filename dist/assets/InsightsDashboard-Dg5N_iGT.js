const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/InsightsPaywall-CKRBfeNZ.js","assets/index-CsUnqKhe.js","assets/index-WS4L-hDx.css","assets/InsightsPaywall-CE5W3W4m.css","assets/InsightsChartTotal-YXnKz9X5.js","assets/chartjs.utils-9363LULH.js","assets/InsightsSummary-B5ztO72R.js","assets/InsightsSummary-DTFIhBF3.css","assets/index-DgQ_ZCHg.js","assets/InsightsChartFailed-BjgrD-VZ.js","assets/InsightsChartFailureRate-Csvzi0Qv.js","assets/InsightsChartTimeSaved-C9zgbLsZ.js","assets/InsightsChartAverageRuntime-Bu2G-96V.js","assets/InsightsTableWorkflows-BUL1dDyP.js","assets/InsightsTableWorkflows-BTHSCwX8.css"])))=>i.map(i=>d[i]);
import { d as defineComponent, ea as useModel, g3 as useInsightsStore, r as ref, gM as UNLICENSED_TIME_RANGE, gd as TIME_RANGE_LABELS, e as createBlock, g as openBlock, w as withCtx, h as createElementBlock, F as Fragment, A as renderList, l as unref, e3 as _sfc_main$3, k as createTextVNode, f as createCommentVNode, t as toDisplayString, j as createBaseVNode, e2 as N8nSelect, x as computed, c as useI18n, i as createVNode, p as N8nText, q as N8nButton, gN as ElDialog, aA as usePageRedirectionHelper, _ as _export_sfc, a2 as useRoute, gO as INSIGHT_TYPES, dm as defineAsyncComponent, a7 as watch, o as onMounted, ax as useDocumentTitle, m as N8nHeading, n as normalizeClass, dD as _sfc_main$4, c3 as resolveDynamicComponent, aU as __vitePreload, al as useTelemetry, gP as TELEMETRY_TIME_RANGE } from "./index-CsUnqKhe.js";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const InsightsPaywall = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsPaywall-CKRBfeNZ.js"), true ? __vite__mapDeps([0,1,2,3]) : void 0)
    );
    const InsightsChartTotal = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartTotal-YXnKz9X5.js"), true ? __vite__mapDeps([4,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartFailed = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartFailed-BjgrD-VZ.js"), true ? __vite__mapDeps([9,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartFailureRate = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartFailureRate-Csvzi0Qv.js"), true ? __vite__mapDeps([10,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartTimeSaved = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartTimeSaved-C9zgbLsZ.js"), true ? __vite__mapDeps([11,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartAverageRuntime = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartAverageRuntime-Bu2G-96V.js"), true ? __vite__mapDeps([12,1,2,5,6,7,8]) : void 0)
    );
    const InsightsTableWorkflows = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsTableWorkflows-BUL1dDyP.js"), true ? __vite__mapDeps([13,1,2,6,7,14]) : void 0)
    );
    const props = __props;
