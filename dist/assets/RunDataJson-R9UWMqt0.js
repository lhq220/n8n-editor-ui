const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/RunDataJsonActions-BvFavmN_.js","assets/index-CsUnqKhe.js","assets/index-WS4L-hDx.css","assets/_commonjs-dynamic-modules-TGKdzP3c.js","assets/RunDataJsonActions-B2jW3_UG.css"])))=>i.map(i=>d[i]);
import { d as defineComponent, aY as useNDVStore, r as ref, ga as useElementSize, x as computed, h0 as executionDataToJson, h as createElementBlock, g as openBlock, e as createBlock, i as createVNode, w as withCtx, f as createCommentVNode, l as unref, dm as defineAsyncComponent, dl as Suspense, h1 as VueJsonPretty, gX as __unplugin_components_0, n as normalizeClass, gY as MappingPill, g6 as Draggable, aU as __vitePreload, gZ as shorten, g$ as getMappedExpression, bo as useExternalHooks, al as useTelemetry, h2 as isString, h3 as nonExistingJsonPath, _ as _export_sfc } from "./index-CsUnqKhe.js";
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const LazyRunDataJsonActions = defineAsyncComponent(
      async () => await __vitePreload(() => import("./RunDataJsonActions-BvFavmN_.js"), true ? __vite__mapDeps([0,1,2,3,4]) : void 0)
    );
    const props = __props;
