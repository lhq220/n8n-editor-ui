const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/RunDataJsonActions-Bbe0aGcd.js","assets/index-B6CXOKcF.js","assets/index-Cu27tAiF.css","assets/_commonjs-dynamic-modules-TGKdzP3c.js","assets/RunDataJsonActions-B2jW3_UG.css"])))=>i.map(i=>d[i]);
import { d as defineComponent, aP as useNDVStore, r as ref, g2 as useElementSize, x as computed, gJ as executionDataToJson, h as createElementBlock, g as openBlock, e as createBlock, i as createVNode, w as withCtx, f as createCommentVNode, l as unref, dj as defineAsyncComponent, di as Suspense, gK as VueJsonPretty, gE as __unplugin_components_0, n as normalizeClass, gF as MappingPill, f$ as Draggable, aL as __vitePreload, gG as shorten, gI as getMappedExpression, bg as useExternalHooks, aA as useTelemetry, gL as isString, gM as nonExistingJsonPath, _ as _export_sfc } from "./index-B6CXOKcF.js";
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const LazyRunDataJsonActions = defineAsyncComponent(
      async () => await __vitePreload(() => import("./RunDataJsonActions-Bbe0aGcd.js"), true ? __vite__mapDeps([0,1,2,3,4]) : void 0)
    );
    const props = __props;
